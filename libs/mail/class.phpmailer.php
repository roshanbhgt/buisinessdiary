...
class PHPMailer
{
    ...
    public function __construct($exceptions = false)
    {
		...
		$this->Host = "mail.foodiespecial.in";
		//Set the SMTP port number - likely to be 25, 465 or 587
		$this->Port = 25;
		//Whether to use SMTP authentication
		$this->SMTPAuth = true;
		//Username to use for SMTP authentication
		$this->Username = "foodiesp";
		//Password to use for SMTP authentication
		$this->Password = "00xN2p2Xos";
    }
     ...
     */
    public function send($from,$to,$subject,$body,$cc = null,$bcc = null, $attachment = null)
    {
		...
		$this->addReplyTo('help@foodiespecial.in', 'Help');
		...
		$this->msgHTML($message, dirname(__FILE__));
		//Replace the plain text body with one created manually
		$this->AltBody = 'If you can\'t see this mail to help@foodiespecial.in';
