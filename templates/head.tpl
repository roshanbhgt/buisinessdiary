...
<META NAME="ROBOTS" CONTENT="INDEX, FOLLOW"><meta name="google-translate-customization" content="193ef7c54e757c05-7232cdb5576d446c-g5c40ae9f56e8e1f5-13"></meta>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            (function request() {
                $.ajax({
                   type: "GET",
                    url: "http://"+document.domain+"/weather.php",
                    cache: false,
        ...
        function submitnewsletter(){
            ...
            form.on('submit', function(e) {
                ...
                $.ajax({
                    url: 'http://'+document.domain+'/emailnewsletter.php', // form action url
        ...
        function submitquiklist(){
            ...
            form.on('submit', function(e) {
                ...
                // sending ajax request through jQuery
                $.ajax({
                    url: 'http://'+document.domain+'/quiklist.php', // form action url
                    type: 'POST', // form submit method get/post
                    dataType: 'html', // request type html/json/xml
                    data: form.serialize(), // serialize form data
                    beforeSend: function() {
