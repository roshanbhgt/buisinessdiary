        <div class="logo">
			<a href="{$FRONTEND}">
				<img alt="Buisiness Diary" src="{$FRONTEND}/design/images/logo.png" height="85" width="250"/>
			</a>
		</div>
        <div class="top-links">        
        	<ul>
...
<div id="google_translate_element" style="float: right;padding: 10px 0px 10px 10px;"></div>
{literal}
<script type="text/javascript">
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', layout: google.translate.TranslateElement.InlineLayout.SIMPLE, gaTrack: true, gaId: 'UA-47488904-1'}, 'google_translate_element');
}
