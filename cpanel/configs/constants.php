...
define ('FRONTEND','http://localhost/buisinessdiary/');
define ('BACKEND','http://localhost/buisinessdiary/cpanel/');
...
define ('SESSION_BACKEND_PATH','C:\xampp\htdocs\buisinessdiary\cpanel\session');
